...
const Header = () => {
  ...
  `}</style> */}
            ...
            {/* LEFT CONTENT */}
            <div className={`col-md-6 d-flex flex-column justify-content-center px-2 mt-5 ${hasNewHero ? style.enhancedHeroLeft : ""}`}>
              {card && (
                <>
                  {/* PRE-HEADING */}
                  ...
                  <div className={style.heroBenefitsGrid}>
                    {card?.heroContent?.benefits?.map(
                      (benefit, index) => {
                        const benefitIcon =
                          heroBenefitIcons[
                          index % heroBenefitIcons.length
                          ];
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className={style.heroBenefitContent}>
                              {benefit}
                            </div>
                          </div>
                        );
                  ...
                  <div className={style.heroCtaContainer}>
                    ...
                    <p className={style.heroHelperText}>
                      <span className={style.heroHelperIcon}>
